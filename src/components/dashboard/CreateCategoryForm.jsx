  ...
  const onSubmit = async (data) => {
    if (isUpdate) {
      await makePutRequest({
        data,
        endpoint: `/api/categories/${initialData.id}`,
        redirectPath: "/dashboard/inventory/categories",
    ...
    <div>
      <div className="mx-auto max-w-4xl space-y-6">
        <FormHeader
          ...
          title={isUpdate ? "Cập nhật danh mục" : "Tạo danh mục mới"}
        />
        <form
        ...
        >
          ...
          <div className="mt-6 flex items-center gap-3">
            <SubmitButton
              buttonTitle={isUpdate ? "Cập nhật" : "Tạo danh mục"}
              isLoading={isLoading}
            />
            <Link
