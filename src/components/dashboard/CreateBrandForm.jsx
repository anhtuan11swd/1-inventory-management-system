  ...
  const onSubmit = async (data) => {
    if (isUpdate) {
      await makePutRequest({
        data,
        endpoint: `/api/brands/${initialData.id}`,
        redirectPath: "/dashboard/inventory/brands",
    ...
    <div>
      <div className="mx-auto max-w-4xl space-y-6">
        <FormHeader
          ...
          title={isUpdate ? "Cập nhật thương hiệu" : "Tạo thương hiệu mới"}
        />
        <form
        ...
        >
          ...
          <div className="mt-6 flex items-center gap-3">
            <SubmitButton
              buttonTitle={isUpdate ? "Cập nhật" : "Tạo thương hiệu"}
              isLoading={isLoading}
            />
            <Link
